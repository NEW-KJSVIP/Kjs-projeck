...
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/NEW-KJSVIP/Kjs-projeck/main/Enc/encrypt" ; chmod +x /usr/bin/enc
...
wget https://raw.githubusercontent.com/NEW-KJSVIP/Kjs-projeck/main/Cfg/m-noobz 
